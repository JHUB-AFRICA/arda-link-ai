 ...
 *     Prefers the herder's own permanently-stored location (Jisajili
 *     registration or an explicit relocation, see overlayStoredLocation)
 *     when set; falls back to the ward centroid (the geographic centre
 *     of the ward, not the herder's actual location) otherwise.
 */
